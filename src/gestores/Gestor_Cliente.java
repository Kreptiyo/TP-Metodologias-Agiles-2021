...
public class Gestor_Cliente {
	...
	public void actualizarCliente(Integer id, String nombre, String localidad, String apellido, Integer telefono, String barrio, Integer monto, String mail, String contraseña, String documento)
	{	
		c.setId(id);
		c.setNombre(nombre);
	...
	public void actualizarCliente(String nombre, String localidad, String apellido, Integer telefono, String barrio, Integer monto, String mail, String contraseña, String documento)
	{	
		c.setNombre(nombre);
		c.setLocalidad(localidad);
		c.setApellido(apellido);
